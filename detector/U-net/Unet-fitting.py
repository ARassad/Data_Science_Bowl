...
def model_Unet(height, width, channels):
    ...
    c1 = Conv2D(4, (3, 3), activation='elu', kernel_initializer='he_normal', padding='same')(inputs)
    c1 = Dropout(0.1)(c1)
    ...
    c5 = Conv2D(12, (3, 3), activation='elu', kernel_initializer='he_normal', padding='same')(p2)
    c5 = Dropout(0.3)(c5)
    c5 = Conv2D(12, (3, 3), activation='elu', kernel_initializer='he_normal', padding='same')(c5)

    u8 = Conv2DTranspose(8, (2, 2), strides=(2, 2), padding='same')(c5)
...
if __name__ == "__main__":
    ...
    X_train, Y_train = get_data("../../../data/detector/", length=None, size=(20, 20, 1))
